...
final class BeamComponent: UIView {
    ...
    private func setupScene() {
        ...
        scene.fogStartDistance = .greatestFiniteMagnitude
        scene.fogEndDistance = .greatestFiniteMagnitude
    ...
    private func setupReflectiveFloor() {
        guard let scene = sceneView.scene else { return }
        ...
        node.position = SCNVector3(0, -beamThicknessY, 0)
